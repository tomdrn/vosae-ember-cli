 ...
 * @class InvoiceMakeableMixin
 * @extends Ember.Mixin
###

InvoiceMakeableMixin = Ember.Mixin.create
  ...
  #     store = @get('store')
  #     adapter = store.adapterForType(Quotation)
...
`export default InvoiceMakeableMixin`
